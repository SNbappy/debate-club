...
export default async function AdminCertificatesPage() {
  ...
  const [{ data: certificates }, { count: memberCount }] = await Promise.all([
  ...
  return (
    <div className="max-w-6xl">
      ...
      <CertificatesAdminClient certificates={(certificates as unknown as Parameters<typeof CertificatesAdminClient>[0]["certificates"]) ?? []} memberCount={memberCount ?? 0} />
    </div>
  )
}
